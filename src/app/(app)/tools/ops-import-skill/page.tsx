...
export const metadata: Metadata = { title: 'Ops Import Skill — Tools' };
...
export default function OpsImportSkillPage() {
  return (
    <div>
      <PageHeader title="Ops Import Skill" backHref="/tools" backLabel="Tools" />
